...
import { ErrorHandler, type ErrorDialogProps } from './ErrorHandler';
...
const Dialog = (props: ErrorDialogProps) => (
  <button data-testid="dialog" onClick={props.onClose}>
    {props.error.message}
  </button>
);
...
describe('ErrorHandler', () => {
  ...
  it('catches a child that throws while rendering, rather than losing the screen', () => {
    const Exploding = () => {
    ...
    expect(dialog()?.textContent).toBe('render exploded');
  });
